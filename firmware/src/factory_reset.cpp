...
// (factory_info.h, partitions.csv) — the serial number is mass-production
// identity, not user/pairing state, and must survive a factory reset.
// Nothing in this file (or anywhere else in the firmware) opens that
// partition read-write; only the one-time manufacturing flash
