...
constexpr const char* k_notif_filter = "notif_filt";  // uint8: 0=Disabled 1=CallOnly 2=Important 3=AppPassthrough 4=All
...
uint8_t get_notif_filter() {
    return get_uchar(k_notif_filter, 0x04);  // default: All
}
