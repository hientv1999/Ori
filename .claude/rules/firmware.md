...
- **NVS persistence**: profile, PTO, backlight state, pairing bonds — survives power cycles. **Meeting list and local time are RAM-only** (deliberately not persisted) — re-synced from Orion on reconnect; see `meeting-list.md`
